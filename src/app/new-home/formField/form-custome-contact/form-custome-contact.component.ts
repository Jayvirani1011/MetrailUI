...
@Component({
  selector: 'app-form-custome-contact',
  templateUrl: './form-custome-contact.component.html',
  styleUrls: ['./form-custome-contact.component.css']
})
export class FormCustomeContactComponent {
