...
@Component({
  selector: 'app-date-custome-header',
  templateUrl: './date-custome-header.component.html',
  styleUrls: ['./date-custome-header.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DateCustomeHeaderComponent {
